...
class RecommendationsSectionTablet extends StatefulWidget {
  const RecommendationsSectionTablet({super.key});

  @override
  State<RecommendationsSectionTablet> createState() =>
      _RecommendationsSectionTabletState();
}

class _RecommendationsSectionTabletState
    extends State<RecommendationsSectionTablet> {
